...
const StatusBadge = memo(() => (
  ...
  >
    <div className="relative group">
      <div className="absolute -inset-0.5 bg-gradient-to-r from-[#3b82f6] to-[#f87171] rounded-full blur opacity-30 group-hover:opacity-50 transition duration-1000"></div>
      <div className="relative px-3 py-2 border rounded-full sm:px-4 bg-black/40 backdrop-blur-xl border-white/10">
        <span className="bg-gradient-to-r from-[#3b82f6] to-[#f87171] text-transparent bg-clip-text sm:text-sm text-[0.7rem] font-medium flex items-center">
  ...
  <div className="space-y-2" data-aos="fade-up" data-aos-delay="600">
    <h1 className="text-5xl font-bold tracking-tight sm:text-6xl md:text-6xl lg:text-6xl xl:text-7xl">
      <span className="relative inline-block">
        <span className="absolute -inset-2 bg-gradient-to-r from-[#3b82f6] to-[#f87171] blur-2xl opacity-20 pd-10"></span>
      ...
      <span className="relative inline-block mt-2">
        <span className="absolute -inset-2 bg-gradient-to-r from-[#3b82f6] to-[#f87171] blur-2xl opacity-20"></span>
        <span className="relative bg-gradient-to-r from-[#3b82f6] to-[#f87171] bg-clip-text text-transparent">
          Developer
        </span>
      </span>
    </h1>
...
const SocialLink = memo(({ icon: Icon, link }) => (
  <a href={link} target="_blank" rel="noopener noreferrer">
    <button className="relative p-3 group">
      <div className="absolute inset-0 bg-gradient-to-r from-[#3b82f6] to-[#f87171] rounded-xl blur opacity-20 group-hover:opacity-40 transition duration-300"></div>
          ...
          <div className="flex flex-col items-center justify-center h-auto gap-6 lg:flex-row sm:h-screen md:justify-between sm:gap-12 lg:gap-20">
            ...
            >
              <div className="space-y-4 sm:space-y-6">
                ...
                >
                  ...
                  <span className="w-[3px] h-6 bg-gradient-to-t from-[#3b82f6] to-[#f87171] ml-1 animate-blink"></span>
                </div>
            ...
            >
              <div className="relative w-full opacity-90">
                <div
                  className={`absolute inset-0 bg-gradient-to-r from-[#3b82f6]/10 to-[#f87171]/10 rounded-3xl blur-3xl transition-all duration-700 ease-in-out ${isHovering ? "opacity-50 scale-105" : "opacity-20 scale-100"
                    }`}
                ></div>
